...
//         <div className="text-center max-w-[40rem] mx-auto my-20">
...
//           </p>
//         </div>
//         <div className="max-w-6xl mx-auto flex justify-evenly gap-6 my-20 max-md:flex-col">
//           <div className="md:space-y-8 max-md:flex max-md:justify-center max-md:gap-4 max-[500px]:flex-col max-[500px]:max-w-60 max-[500px]:mx-auto">
...
//                 </svg>
//               </span>
//               <span className=" max-w-48 text-black/90 space-y-2">
...
//             <Input label="Your name" placeholder="Abc" className="w-[30rem] py-8 px-4 placeholder:text-[#9F9F9F]" />
//             <Input label="Email address" placeholder="abc@def.com" className="w-[30rem] py-8 px-4 placeholder:text-[#9F9F9F]"/>
//             <Input label="Subject" placeholder="This is optional" className="w-[30rem] py-8 px-4 placeholder:text-[#9F9F9F]"/>
//             <Textarea label="Message" placeholder="Hi! i’d like to ask about" className="w-[30rem] h-28 py-4 px-4 placeholder:text-[#9F9F9F]"/>
//             <Button variant={'fBtn2'} size={'f2'} className="px-20">Submit</Button>
//           </div>
//         </div>
//       </Container>
//       <DeliveryServices />

...
function NewArrivals() {
  return (
    ...
    <div className='w-full  h-[38rem] grid grid-cols-1 max-md:grid-rows-2 md:grid-cols-3'>
        <div className='md:col-span-2 max-md:h-80 w-[28rem] md:w-full mx-auto '>
            <Image src={'/Asgaard sofa 1.png'} alt={'Asgaard sofa'} className='w-full h-5/6 mt-20 md:mb-auto' width={1000} height={1000} />
        </div>
        <div className='col-span-1 flex justify-center items-center md:mr-auto md:ml-6'>
